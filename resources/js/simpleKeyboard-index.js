...
function handleCapsClick() {
  ...
  if (isCaps) {
    ...
    if(isEnglish) {
    	document.querySelector(".caps-label").innerText = "a→A"
    }else{
    	document.querySelector(".caps-label").innerText = "ㄱ→ㄲ"
    }
  } else {
    ...
    if(isEnglish) {
    	...
    	document.querySelector(".caps-label").innerText = "ㄲ→ㄱ"
    }
  }
